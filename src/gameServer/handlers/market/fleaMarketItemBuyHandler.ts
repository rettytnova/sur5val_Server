import { Card, CustomSocket, FleaMarketItemSelectPayload, Room, User } from '../../../gameServer/interface/interface.js';
...
export const fleaMarketItemBuy = async (socket: CustomSocket, payload: Object) => {
