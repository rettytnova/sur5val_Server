...
export const config = {
  ...
  chattingPacketType: {
    CHATTING_LOGIN_REQUEST: 1001,
    CHATTING_LOGIN_RESPONSE: 1002,
    CHATTING_CREATE_ROOM_REQUEST: 1003,
    CHATTING_CREATE_ROOM_RESPONSE: 1004,
    CHATTING_JOIN_ROOM_REQUEST: 1005,
    CHATTING_LEAVE_ROOM_REQUEST: 1006,
    CHATTING_CHAT_SEND_REQUEST: 1007,
    CHATTING_CHAT_SEND_RESPONSE: 1008
  }
};
